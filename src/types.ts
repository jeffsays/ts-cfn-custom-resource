...
/**
 * Defines the shape of CloudFormation's custom resource event object
 * relevant to sending status back to CloudFormation.
 */
...
/** @description Defines the details that must be sent in the response to CloudFormation. */
